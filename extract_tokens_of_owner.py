...
if __name__ == '__main__':
    ...
    while True:
        ...
        if local_block_height < current_block_number:
            event_logs = get_logs(w3,local_block_height, block_interval,contractAddressList=tokens)
